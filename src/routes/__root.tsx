...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Kathāsāgara — Indian Mythology, Retold" },
      { name: "description", content: "AI-narrated tales from the Ramayana, Mahabharata, and Puranas." },
      { property: "og:title", content: "Kathāsāgara — Indian Mythology, Retold" },
